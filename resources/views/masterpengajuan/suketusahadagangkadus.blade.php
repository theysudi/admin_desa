...
@section('breadcrumb')
    <div class="row mb-2">
        <div class="col-sm-6">
            <h1 class="m-0">Proses Surat Keterangan Usaha Dagang Kadus</h1>
        </div>
        <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="#">Home</a></li>
                <li class="breadcrumb-item active">Proses Surat Keterangan Usaha Dagang</li>
            </ol>
        </div>
    </div>
@endsection
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('masterpengajuan.storesuketusahadagangkadus') }}" method="post"
                            autocomplete="off">
                            @csrf
                            @method('POST')
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="nomor_surat" id="nomor_surat" value="10/KBD.NYP/III/2023"
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nama_kadus" id="nama_kadus" placeholder="Nama Kadus"
                                        class="form-control">
                                </div>
                                <div class="form-group">
                                    <label>Jabatan Kadus</label>
                                    <input type="text" name="jabatan_kadus" id="jabatan_kadus"
                                        placeholder="Jabatan Kadus" class="form-control">
                                </div>
                                <div class="form-group">
                                    <label>Alamat Kadus</label>
                                    <input type="text" name="alamat_kadus" id="alamat_kadus" placeholder="Alamat Kadus"
                                        class="form-control">
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="input-group">
                                    <a class="btn btn-lg btn-block btn-primary" href="{{ url($data->file_bukti) }}"
                                        target="_blank">
                                        Lihat Surat Pernyataan Pemohon
                                    </a>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <div class="form-group">
                                    ...
                                    Berdasarkan Surat Pernyataan yang ditanda tangani oleh Ni Komang Suryati, memang benar orang tersebut mempunyai usaha Dagang. Surat pernyataan ini saya buat untuk keperluan mengurus administrasi kredit Bank BRI. Demikian surat keterangan ini dibuat sebagai dasar penerbiatan Surat Keterangan olebh Perbekel
                                 </textarea>
                                </div>
                            </div>
