...
@section('breadcrumb')
    <div class="row mb-2">
        <div class="col-sm-6">
            <h1 class="m-0">Proses Surat Keterangan Usaha Dagang</h1>
        </div>
        <div class="col-sm-6">
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('masterpengajuan.storesuketusahadagang') }}" method="post"
                            autocomplete="off">
                            @csrf
                            @method('POST')
                            ...
                            <div class="form-group">
                                <div class="form-group">
                                    <textarea name="deskripsi" class="form-control catatan" rows="3" placeholder="Catatan...">
                                        Berdasarkan Surat Keterangan dari Kelian Banjar Dinas Babung Nomor: 43/ KBD.B/ VIII/ 2023 Tanggal 9 Agustus 2023. Memang benar nama tersebut diatas mempunyai usaha dagang. Surat keterangan ini diterbitkan untuk keperluan mengurus kelengkapan administrasi pengajuan kredit di BANK BRI. Demikian surat keterangan ini dibuat, untuk dapat dipergunakan sebagai mana mestinya.
                                 </textarea>
                                </div>
                            </div>
