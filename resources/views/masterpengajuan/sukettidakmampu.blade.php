...
@section('breadcrumb')
    <div class="row mb-2">
        <div class="col-sm-6">
            <h1 class="m-0">Proses Surat Keterangan Tidak Mampu</h1>
        </div>
        <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="#">Home</a></li>
                <li class="breadcrumb-item active">Proses Surat Keterangan Tidak Mampu</li>
            </ol>
        </div>
    </div>
@endsection
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('masterpengajuan.storesukettidakmampu') }}" method="post"
                            autocomplete="off">
                            @csrf
                            @method('POST')
                            ...
                            <div class="form-group">
                                <div class="form-group">
                                    <textarea name="deskripsi" class="form-control catatan" rows="3" placeholder="Catatan...">
                                        Memang benar orang tersebut diatas adalah warga Kurang Mampu. Surat keterangan ini dibuat untuk keperluan mengurus administrasi operasi katarak. Demikian surat keterangan ini dibuat, untuk dapat dipergunakan sebagai mana mestinya.
                                 </textarea>
                                </div>
                            </div>
