...
<table style="width: 100%; font-size:10pt; margin-right:70px;" border="0">
    <tr>
        <td>
        <td colspan="2" style="text-align: right; ">Gunaksa, 13 September 2023</td>
        </td>
    </tr>
</table>
...
<table style="width: 100%; font-size:10pt; margin-bottom:10px;" border="0">
    <tr>
        ...
        <td> Berdasarkan Surat Pernyataan yang ditanda tangani oleh Ni Komang Suryati, memang benar orang tersebut
            mempunyai usaha Dagang. Surat pernyataan ini saya buat untuk keperluan mengurus administrasi di Bank BRI.
            Demikian surat keterangan ini dibuat sebagai dasar penerbitan Surat Keterangan oleh Perbekel</td>
    </tr>
</table>
