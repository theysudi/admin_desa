				...
				<div class="card">
					...
					<div class="card-body">
						<form action="{{ route('desacerdas.store') }}" method="post" autocomplete="off" enctype="multipart/form-data">
							...
							<div class="form-group">
								<label>Jenis</label>
								<select name="jenis" id="jenis" class="form-control s2" style="width: 100%;">
							...
							<div class="form-group">
								...
								<div class="form-group">
									<textarea name="keterangan" class="form-control catatan" rows="3" placeholder="Keterangan..."></textarea>
								</div>
							</div>
							<div class="form-group">
