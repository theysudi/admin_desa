<nav class="main-header navbar navbar-expand navbar-dark border-bottom-0" style="background-color: #007bff;">
    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown user user-menu">
            ...
            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right rounded p-4"
                style="left: inherit; right: 0px;">
                <div class="user-header text-center">
                    <img src="{{ asset('assets/images/profile-default.png') }}" class="img-circle img-fluid w-50"
                        alt="User Image">
                    <hr>
                    <h6>
                        {{ Auth::user()->name ?? '-' }} - <span
                            class="text-danger">{{ Auth::user()->role->name ?? '-' }}</span>
                    </h6>
                        ...
                        <td style="width: 50%; text-align: left;">
                            @if (Auth::user()->role->id == '3')
                                <a style="width: 78px;" class="btn btn-sm btn-info"><i class="fas fa-user"></i>
                                    Profile</a>
                            @else
                                <a style="width: 78px;"href="#" class="btn btn-sm btn-info"><i
