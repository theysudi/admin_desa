...
@section('breadcrumb')
    <div class="row mb-2">
        <div class="col-sm-6">
            <h1 class="m-0">Proses Surat Keterangan Nama Sama/Alias</h1>
        </div>
        <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="#">Home</a></li>
                <li class="breadcrumb-item active">Proses Surat Keterangan Nama Sama/Alias</li>
            </ol>
        </div>
    </div>
@endsection
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('masterpengajuan.storesuketnamaalias') }}" method="post" autocomplete="off">
                            @csrf
                            @method('POST')
                            ...
                            <div class="card-title">Masukkan Nama Alias/Sama</div>
                            <div class="card-body">
                                <div class="form-group"></div>
                                <div class="form-group">
                                    <label>Nama</label>
                                    <input type="text" name="nama_lain" id="nama_lain" placeholder="Nama Lengkap"
                                        class="form-control">
                                </div>
                                <div class="form-group">
                                    <label>Tempat Lahir</label>
                                    <input type="text" name="tempat_lahir_lain" id="tempat_lahir_lain"
                                        placeholder="Tempat Lahir" class="form-control">
                                </div>
                                <div class="form-group">
                                    <label>Tanggal Lahir</label>
                                    <div class="input-group date" id="tanggal_sampai4" data-target-input="nearest">
                                        <input type="text" class="form-control datetimepicker-input"
                                            data-target="#tanggal_sampai4" id="tgl_lahir_lain" name="tgl_lahir_lain"
                                            data-toggle="datetimepicker">
                                        <div class="input-group-append" data-target="#tanggal_sampai4"
                                            data-toggle="datetimepicker">
                                            <div class="input-group-text"><i class="fa fa-calendar"></i></div>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group">
                                    <label>Jenis Kelamin</label>
                                    <input type="text" name="jenis_kelamin_lain" id="jenis_kelamin_lain"
                                        placeholder="Jenis Kelamin" class="form-control">
                                </div>
                                <div class="form-group">
                                    <label>Agama</label>
                                    <input type="text" name="agama_lain" id="agama_lain" placeholder="Agama"
                                        class="form-control">
                                </div>
                                <div class="form-group">
                                    <label>Alamat</label>
                                    <input type="text" name="alamat_lain" id="alamat_lain" placeholder="Alamat"
                                        class="form-control">
                                </div>
                            ...
                            <div class="form-group">
                                <div class="form-group">
                                    <textarea name="deskripsi" class="form-control catatan" rows="3" placeholder="Catatan...">
                                        Sepanjang pengetahuan kami memang benar orang tersebut di atas satu atau sama.
...
@section('js')
    ...
    <script>
        $("#tanggal_sampai4").datetimepicker({
            format: 'yyyy-MM-DD',
        });
        script > $("#tanggal_dari4").datetimepicker({
            format: 'DD-MM-yyyy',
        });
    </script>
