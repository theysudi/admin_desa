...
@section('breadcrumb')
    <div class="row mb-2">
        <div class="col-sm-6">
            <h1 class="m-0">Proses Surat Keterangan Pindah Domisili</h1>
        </div>
        <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="#">Home</a></li>
                <li class="breadcrumb-item active">Proses Surat Keterangan Pindah Domisili</li>
            </ol>
        </div>
    </div>
@endsection
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('masterpengajuan.storesuketpindahdomisili') }}" method="post"
                            autocomplete="off">
                            @csrf
                            @method('POST')
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    <div class="form-group">
                                        ...
                                        Memang benar orang tersebut diatas sudah pindah domisili ke Desa Keramas, Kecamatan Blahbatuh, Kabupaten Gianyar. Demikian surat keterangan ini dibuat dengan sebenarnya untuk dapat dipergunakan sebagaiman  mestinya.
                                 </textarea>
                                    </div>
                                </div>
