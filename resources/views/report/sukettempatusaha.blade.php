...
<table style="width: 100%; font-size:10pt; margin-bottom:10px;" border="0">
    <tr style=" line-height: 10%;">
        <td colspan="2" style="text-align: left; padding-left:100px;  line-height: 150%; ">Memang benar orang
            tersebut di atas mempunyai Usaha :
            &nbsp;
...
<table style="width: 100%; font-size:10pt; margin-bottom:10px; margin-left:5%;" border="0">
    <tr>
        <td style="text-align: left; padding-left:100px;  line-height: 150%; ">Nama Usaha
        <td width="5%">: </td>
    ...
    <tr>
        <td style="text-align: left; padding-left:100px;  line-height: 150%; ">Jenis Usaha
        <td width="5%">: </td>
