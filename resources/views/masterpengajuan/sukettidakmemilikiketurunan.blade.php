...
@section('breadcrumb')
    <div class="row mb-2">
        <div class="col-sm-6">
            <h1 class="m-0">Proses Surat Keterangan Tidak Memiliki Keturunan</h1>
        </div>
        <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="#">Home</a></li>
                <li class="breadcrumb-item active">Proses Surat Keterangan </li>
            </ol>
        </div>
    </div>
@endsection
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('masterpengajuan.storesukettidakmemilikiketurunan') }}" method="post"
                            autocomplete="off">
                            @csrf
                            @method('POST')
                            ...
                            <div class="card-title">Masukkan Nama Pasangan</div>
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group date" id="tanggal_sampai4" data-target-input="nearest">
                                        <input type="text" class="form-control datetimepicker-input"
                                            data-target="#tanggal_sampai4" id="tgl_lahir_pasangan"
                                ...
                                <div class="form-group">
                                    <label>Jenis Kelamin</label>
                                    <input type="text" name="jenis_kelamin_pasangan" id="jenis_klmin_pasangan"
                            ...
                            <div class="form-group">
                                <div class="form-group">
                                    <textarea name="deskripsi" class="form-control catatan" rows="3" placeholder="Catatan...">
                                        Memang benar nama tersebut diatas adalah pasangan Suami Istri dan tidak memiliki
                                        keturunan ( Camput ).
                                        Surat Keterangan ini dibuat untuk keperluan mengurus administrasi Pembebasan Lahan
                                        untuk akses PKB atas nama Nang Samberag (Alm).
