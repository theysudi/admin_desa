					...
					<div class="card-body">
						<form action="{{ route('layanankesehatan.store') }}" method="post" autocomplete="off">
							...
							<div class="form-group">
								...
								<div class="input-group date" id="tanggal_sampai" data-target-input="nearest">
									<input type="text" class="form-control datetimepicker-input" data-target="#tanggal_sampai" id="tanggal"
										value="{{ date('Y-m-d') }}" name="tanggal" data-toggle="datetimepicker">
							...
							<div class="form-group">
								...
								<input type="time" name="waktu_mulai" id="waktu_mulai" placeholder="Waktu_mulai" class="form-control">
							</div>
							<div class="form-group">
								<label>Waktu Selesai</label>
								<input type="time" name="waktu_selesai" id="waktu_selesai" placeholder="Waktu_selesai" class="form-control">
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<label>Tempat</label>
								<input type="text" name="tempat" id="tempat" placeholder="Tempat" class="form-control">
							</div>
