...
@section('breadcrumb')
    <div class="row mb-2">
        <div class="col-sm-6">
            <h1 class="m-0">Proses Surat Keterangan Yatim Piatu</h1>
        </div>
        <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="#">Home</a></li>
                <li class="breadcrumb-item active">Proses Surat Keterangan Yatim Piatu</li>
            </ol>
        </div>
    </div>
@endsection
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('masterpengajuan.storesuketyatimpiatu') }}" method="post"
                            autocomplete="off">
                            @csrf
                            @method('POST')
                            ...
                            <div class="form-group">
                                <div class="form-group">
                                    ...
                                    Memang benar orang tersebut diatas adalah Piatu Surat Keterangan ni dipergunakan untuk keperluan melengkapi Administrasi beasiswa sekolah atas nama Made Mely Maharani Putri di SDN 1 Bendul. Demikian Surat Keterangan  ini dibuat agar dapat digunakan sebagaimana mestinya.
                                 </textarea>
                                </div>
                            </div>
