...
<table style="width: 100%; font-size:10pt; margin-bottom:10px;" border="0">
    <tr style=" line-height: 10%;">
        <td colspan="2" style="text-align: left; padding-left:100px;  line-height: 150%; ">Dengan ini menyatakan
            Bahwa :
            &nbsp;
...
<table style="width: 100%; font-size:10pt; margin-bottom:10px; margin-left:5%;" border="0">
    <tr>
        <td style="text-align: left; padding-left:100px;  line-height: 150%; ">Sertifikat &nbsp;
        <td width="5%">: </td>
    ...
    <tr>
        <td style="text-align: left; padding-left:100px;  line-height: 150%; ">Luas
        <td width="5%">: </td>
        <td>{!! $data->luas !!} M<sup>2</sup></td>
        </td>
    </tr>
    <tr>
        <td style="text-align: left; padding-left:100px;  line-height: 150%; ">Letak
        <td width="5%">: </td>
        <td>{!! $data->letak !!}</td>
        </td>
    </tr>
    <tr>
        <td style="text-align: left; padding-left:100px;  line-height: 150%; ">Kecamatan
        <td width="5%">: </td>
        <td>{!! $data->kecamatan !!}</td>
        </td>
    </tr>
    <tr>
        <td style="text-align: left; padding-left:100px;  line-height: 150%; ">Kabupaten
        <td width="5%">: </td>
        <td>{!! $data->kabupaten !!}</td>
        </td>
    </tr>
    <tr>
        <td style="text-align: left; padding-left:100px;  line-height: 150%; ">Atas Nama
        <td width="5%">: </td>
