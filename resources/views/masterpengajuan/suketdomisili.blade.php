...
@section('breadcrumb')
    <div class="row mb-2">
        <div class="col-sm-6">
            <h1 class="m-0">Proses Surat Keterangan Domisili</h1>
        </div>
        <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="#">Home</a></li>
                <li class="breadcrumb-item active">Proses Surat Keterangan Domisili</li>
            </ol>
        </div>
    </div>
@endsection
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('masterpengajuan.storesuketdomisili') }}" method="post" autocomplete="off">
                            @csrf
                            @method('POST')
                            ...
                            <div class="form-group">
                                <div class="form-group">
                                    ...
                                    Sepanjang sepengetahuan kami memang benar orang tersebuat di atas adalah warga Banjar Dinas Nyamping Desa Gunaksa kec. Dawan kab. Klungkung dan tinggal di Banjar Dinas Nyamping Desa Gunaksa Kec. Dawan Kab. Klungkung. Demikian Surat Keterangan  ini dibuat untuk dapat dipergunakan sebagaimana mestinya. 
                                 </textarea>
                                </div>
                            </div>
